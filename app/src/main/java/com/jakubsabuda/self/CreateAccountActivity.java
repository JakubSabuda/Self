...
public class CreateAccountActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        passwordEditText = findViewById(R.id.password_acocunt);
        userNameEditText = findViewById(R.id.acct_name);
        ...
        createAccButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!TextUtils.isEmpty(emailEditText.getText().toString())
                    ...
                    createUserEmailAcocunt(email, password, username);
                } else {
    ...
    private void animation() {
        LinearLayout linearLayout = findViewById(R.id.activity_create_acocunt_id);
    ...
    private void createUserEmailAcocunt(String email, String password, final String username) {
            ...
            firebaseAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if (task.isSuccessful()) {
                        //Take use to AddJournalActivity
                        currentUser = firebaseAuth.getCurrentUser();
